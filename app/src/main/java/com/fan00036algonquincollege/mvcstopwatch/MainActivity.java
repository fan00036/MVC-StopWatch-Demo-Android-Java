...
public class MainActivity extends AppCompatActivity implements Observer{
    ...
    protected void onStop() {
        ...
        editor.putInt( "hours",   mStopwatchModel.getHours() );
        editor.putInt( "minutes", mStopwatchModel.getMinutes() );
        editor.putInt( "seconds",  mStopwatchModel.getSeconds() );
        editor.putInt( "tenthOfASecond", mStopwatchModel.getTenthOfASecond() );
